...
Home.destroy_all
Review.destroy_all
HomePreference.destroy_all

#Seed Users
demo = User.create(email: "demo@demo.com", password: "123123", first_name: "Demo", last_name: "User", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u1 = User.create(email: "test123@gmail.com", password: "123123", first_name: "Andrew", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u2 = User.create(email: "angTest@gmail.com", password: "123123", first_name: "Angelina", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u3 = User.create(email: "tsj11@gmail.com", password: "123123", first_name: "Terry", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u4 = User.create(email: "todd@gmail.com", password: "123123", first_name: "Todd", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u5 = User.create(email: "michael@gmail.com", password: "123123", first_name: "Michael", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u6 = User.create(email: "sarah@gmail.com", password: "123123", first_name: "Sarah", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u7 = User.create(email: "mike@gmail.com", password: "123123", first_name: "Mike", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u8 = User.create(email: "julie@gmail.com", password: "123123", first_name: "Julie", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u9 = User.create(email: "ken@gmail.com", password: "123123", first_name: "Ken", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
u10 = User.create(email: "ralph@gmail.com", password: "123123", first_name: "Ralph", last_name: "Test", safety_score: "7", food_score: "8", transit_score: "9", clean_score: "10")
...
h1 = Home.create(
    ...
    latitude: 37.799021,
    longitude: -122.40149,
    safety_score: SafetyScoreEngine.test_prediction(37.751677, -122.432468),
    price: 70.00
)
...
h16 = Home.create(
    ...
    latitude: 43.658573,
    longitude: -79.527067,
    safety_score: SafetyScoreEngine.test_prediction(43.658573, -79.527067),
    price: 85.00
)
...
h17 = Home.create(
    ...
    latitude: 43.783132,
    longitude: -79.355406,
    safety_score: SafetyScoreEngine.test_prediction(43.783132, -79.355406),
    price: 85.00
)
...
h18 = Home.create(
    ...
    latitude: 43.646572,
    longitude: -79.427374,
    safety_score: SafetyScoreEngine.test_prediction(43.646572, -79.427374),
    price: 85.00
)
...
h19 = Home.create(
    ...
    latitude: 43.688773,
    longitude: -79.450813,
    safety_score: SafetyScoreEngine.test_prediction(43.688773, -79.450813),
    price: 85.00
)
...
h20 = Home.create(
    ...
    latitude: 43.681402,
    longitude: -79.562148,
    safety_score: SafetyScoreEngine.test_prediction(43.681402, -79.562148),
    price: 85.00
)
...
h21 = Home.create(
    ...
    latitude: 43.667636,
    longitude: -79.387242,
    safety_score: SafetyScoreEngine.test_prediction(43.667636, -79.387242),
    price: 85.00
)

h22 = Home.create(
    host_id: u8.id,
    name: "Fancy Toronto Apartment",
    city: "Toronto",
    max_guests: 2,
    num_rooms: 2,
    num_beds: 2,
    ...
    latitude: 43.636083,
    longitude: -79.404895,
    safety_score: SafetyScoreEngine.test_prediction(43.636083, -79.404895),
    price: 85.00
)
...
h23 = Home.create(
    ...
    latitude: 43.663832,
    longitude: -79.358804,
    safety_score: SafetyScoreEngine.test_prediction(43.663832, -79.358804),
    price: 85.00
)
...
h24 = Home.create(
    ...
    latitude: 43.652472,
    longitude: -79.404761,
    safety_score: SafetyScoreEngine.test_prediction(43.652472, -79.404761),
    price: 85.00
)
...
h25 = Home.create(
    ...
    latitude: 43.647213,
    longitude: -79.373726,
    safety_score: SafetyScoreEngine.test_prediction(43.647213, -79.373726),
    price: 85.00
)
...
f16 = File.open("app/assets/images/h1.jpg")
h16.photo.attach(io: f16, filename: "bed-bedroom-contemporary-1267438.jpg")

f17 = File.open("app/assets/images/h2.jpg")
h17.photo.attach(io: f17, filename: "h2.jpg")

f18 = File.open("app/assets/images/h3.jpg")
h18.photo.attach(io: f18, filename: "h3.jpg")

f19 = File.open("app/assets/images/h4.jpg")
h19.photo.attach(io: f19, filename: "h4.jpg")

f20 = File.open("app/assets/images/h5.jpg")
h20.photo.attach(io: f20, filename: "h5.jpg")

f21 = File.open("app/assets/images/h6.jpg")
h21.photo.attach(io: f21, filename: "h6.jpg")

f22 = File.open("app/assets/images/h7.jpg")
h22.photo.attach(io: f22, filename: "h7.jpg")

f23 = File.open("app/assets/images/h8.jpg")
h23.photo.attach(io: f23, filename: "h8.jpg")

f24 = File.open("app/assets/images/h9.jpg")
h24.photo.attach(io: f24, filename: "h9.jpg")

f25 = File.open("app/assets/images/h10.jpg")
h25.photo.attach(io: f25, filename: "h10.jpg")

#User Photo Seed

#Home Preference
home1 = HomePreference.create(
    home_id: h1.id,
    user_id: u2.id,
    is_liked: 1.0
)

home2 = HomePreference.create(
    home_id: h6.id,
    user_id: u2.id,
    is_liked: 5.0
)
home3 = HomePreference.create(
    home_id: h1.id,
    user_id: u3.id,
    is_liked: 1.0
)
home4 = HomePreference.create(
    home_id: h6.id,
    user_id: u3.id,
    is_liked: 5.0
)
home5 = HomePreference.create(
    home_id: h4.id,
    user_id: u3.id,
    is_liked: 5.0
)

home6 = HomePreference.create(
    home_id: h1.id,
    user_id: u4.id,
    is_liked: 1.0
)
home7 = HomePreference.create(
    home_id: h6.id,
    user_id: u4.id,
    is_liked: 5.0
)
home8 = HomePreference.create(
    home_id: h7.id,
    user_id: u4.id,
    is_liked: 1.0
)
